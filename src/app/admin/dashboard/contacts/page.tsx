    ...
    return (
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
              ...
              <div key={i} className="rounded-xl border border-white/[0.08] bg-white/[0.04] p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="h-2.5 w-44 animate-pulse rounded bg-white/[0.06]" />
                  </div>
                </div>
          ...
          <div className="lg:col-span-3 h-64 animate-pulse rounded-2xl bg-white/[0.04]" />
        </div>
      </div>
    );
  }

  // Unified empty state when no contacts exist at all
      ...
      <div className="flex min-h-[60vh] items-center justify-center">
        ...
        >
          ...
          <p className="mt-2 text-sm text-white/75 leading-relaxed">
            When visitors submit your contact form, their messages will land here.
            You&apos;ll be able to read, search, reply, and export them.
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 gap-2 text-left sm:grid-cols-3">
            {[
              { icon: MailCheck, label: 'Bulk actions' },
          ...
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <div className="relative mb-3">
                ...
                <span className="absolute -right-1 -top-1 h-2 w-2 rounded-full bg-amber-400/60" />
              </div>
              <p className="text-sm font-medium text-white/90">No matches found</p>
              <p className="mt-1 text-xs text-white/75">
                No contacts match &ldquo;{search}&rdquo;. Try a different search term.
              </p>
              <button
                onClick={() => setSearch('')}
                className="mt-4 inline-flex items-center gap-1.5 rounded-xl border border-white/[0.15] bg-white/[0.04] px-4 py-2 text-xs font-medium text-white/90 hover:bg-white/[0.08] hover:text-white transition-all"
              >
                Clear search
              </button>
            </div>

...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-white relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto w-full px-6 md:px-10 lg:px-16 pt-6 md:pt-10">
        <motion.div
      ...
      <motion.div
        ...
        className="relative z-10 max-w-[1200px] mx-auto w-full px-6 md:px-10 lg:px-16 flex-1 flex flex-col"
      >

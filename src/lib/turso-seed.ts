  ...
  const projects = [
    {
      ...
      tag: "Full-Stack", year: "2026", client: "Education", duration: "Apr 2026 – Present",
      role: "Full-Stack Developer",
      overview: "Developed a comprehensive educational management platform supporting institutions through dedicated portals for administrators, branch managers, teachers, and students. Implemented role-based access control, centralized data management, and scalable architecture to support multiple organizational structures.",
      challenge: "Building a multi-tenant architecture that could support multiple institutions with different organizational structures while maintaining data isolation, performance, and a consistent user experience across all portals.",
    ...
    },
    {
      ...
      description: "A UK-focused SaaS platform for staffing and workforce management, delivering streamlined recruitment workflows and scalable operational processes. Designed role-based user experiences and optimized backend services.",
      image: "/staffist.jpg", gallery: JSON.stringify(["/staffist.jpg"]),
      tag: "SaaS / Full-Stack", year: "2026", client: "UK Staffing", duration: "Mar 2026 – Present",
      role: "Full-Stack Developer",
      overview: "Engineered a UK-focused SaaS platform for staffing and workforce management, delivering streamlined recruitment workflows and scalable operational processes. Designed role-based user experiences, optimized backend services, and implemented secure data management practices.",
      challenge: "Creating a scalable SaaS platform that meets UK compliance requirements while delivering intuitive user experiences across different roles and maintaining high performance for complex workforce management operations.",
    ...
    },
    {
      ...
      description: "A full-stack AI-powered educational platform that enhances student learning through intelligent academic assistance tools. Architected scalable frontend and backend systems while integrating AI-driven features for personalized learning experiences.",
      image: "/ilmexa-ai.jpg", gallery: JSON.stringify(["/ilmexa-ai.jpg"]),
      tag: "AI / Full-Stack", year: "2026", client: "University Of Central Punjab", duration: "Feb 2026 – Apr 2026",
      role: "Full-Stack Developer",
      ...
      challenge: "Creating an educational platform that leverages AI to provide truly personalized learning experiences while maintaining fast response times, performance optimization, and an intuitive user interface for students.",
    ...
    },
    {
      ...
      description: "An AI-integrated therapy platform designed to improve accessibility to mental wellness support through intelligent conversational assistance and secure communication channels. Implemented responsive interfaces and backend services prioritizing user experience and privacy.",
      image: "/kenetics-therapy.jpg", gallery: JSON.stringify(["/kenetics-therapy.jpg"]),
      tag: "AI / Healthcare", year: "2025", client: "CodeSquad", duration: "Nov 2024 – Mar 2026",
      role: "Full-Stack Developer",
      overview: "Developed an AI-integrated therapy platform designed to improve accessibility to mental wellness support through intelligent conversational assistance and secure communication channels. Implemented responsive interfaces and backend services that prioritized user experience, privacy, and engagement.",
      challenge: "Developing a healthcare platform that maintains strict security and privacy standards while providing an intuitive experience for users, plus integrating AI capabilities to facilitate personalized support interactions and improve platform usability.",
    ...
    },
    {
      ...
      description: "A modern software company website focused on brand positioning, customer engagement, and lead generation. Developed interactive user experiences and optimized frontend performance for a professional digital presence.",
      image: "/codesquad-ai.jpg", gallery: JSON.stringify(["/codesquad-ai.jpg"]),
      tag: "Frontend", year: "2026", client: "CodeSquad", duration: "Dec 2025 – Jan 2026",
      role: "Frontend Developer",
      overview: "Built a modern software company website focused on brand positioning, customer engagement, and lead generation. Developed interactive user experiences and optimized frontend performance to deliver a professional digital presence.",
      challenge: "Creating a corporate website that effectively positions the brand while maintaining high standards for responsiveness, accessibility, and performance across all devices and browsers.",
    ...
    },
    {
      ...
      description: "A full-stack invoice automation platform enabling businesses to generate professional PDF invoices through customizable templates and automated workflows. Developed secure data management systems and dynamic document generation services.",
      image: "/invoice-system.jpg", gallery: JSON.stringify(["/invoice-system.jpg"]),
      tag: "Automation / Full-Stack", year: "2025", client: "CodeSquad", duration: "Ongoing",
      role: "Full-Stack Developer",
      overview: "Built a full-stack invoice automation platform enabling businesses to generate professional PDF invoices through customizable templates and automated workflows. Developed secure data management systems, dynamic document generation services, and responsive user interfaces.",
      challenge: "Building a reliable invoice automation system that handles complex business logic, customizable templates, and PDF generation while maintaining accuracy, efficiency, and scalability across business operations.",
    ...
    },
    {
      ...
      description: "An intelligent e-commerce platform that leverages AI-powered recommendation systems to deliver personalized shopping experiences. Developed responsive user interfaces and optimized customer journeys to increase product discoverability and engagement.",
      image: "/mamas-compass.jpg", gallery: JSON.stringify(["/mamas-compass.jpg"]),
      tag: "AI / E-Commerce", year: "2025", client: "CodeSquad", duration: "Ongoing",
      role: "Full-Stack Developer",
      overview: "Built an intelligent e-commerce platform that leverages AI-powered recommendation systems to deliver personalized shopping experiences. Developed responsive user interfaces and optimized customer journeys to increase product discoverability and engagement.",
      challenge: "Creating an e-commerce platform with AI-powered recommendations that enhance product discoverability and customer satisfaction while maintaining fast response times and a seamless shopping experience.",
    ...
    },
    {
      ...
      description: "A scalable email automation system that streamlines marketing campaigns, lead nurturing, and customer communication workflows. Developed backend automation pipelines, email delivery processes, and campaign management capabilities.",
      image: "/sales-email-automation.jpg", gallery: JSON.stringify(["/sales-email-automation.jpg"]),
      tag: "Automation / SaaS", year: "2025", client: "CodeSquad", duration: "Ongoing",
      role: "Full-Stack Developer",
      ...
      challenge: "Building a reliable email automation system that handles high-volume email delivery, campaign management, and lead nurturing workflows while reducing manual effort and improving communication efficiency.",
